...
#if (defined(BOARD_NXP_LPCXPRESSO_824) || defined(BOARD_NXP_LPCXPRESSO_812)||defined(BOARD_LPC824LITE))
...
#elif (defined(BOARD_NXP_LPCXPRESSO_824)||defined(BOARD_LPC824LITE))
	/* Enable the clock to the Switch Matrix */
	Chip_Clock_EnablePeriphClock(SYSCTL_CLOCK_SWM);
